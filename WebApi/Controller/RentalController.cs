...
[ApiController]
[Route("[controller]")]
public class RentalController(IRentalCrudService service,IRentalGetService getService) : ControllerBase
{
    [HttpGet]
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAsync([FromBody] RentalCreateDto dto)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> UpdateAsync(int id, [FromBody] RentalUpdateDto dto)
    {
