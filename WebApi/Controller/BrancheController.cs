...
public class BrancheController(IBrancheCrudService service,IBrancheGetService getService) : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAsync([FromBody] BrancheCreateDto dto)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> UpdateAsync(int id, [FromBody] BrancheUpdateDto dto)
    {
